...
void Pacman::Game::PacGameLoop() {
    ...
    sf::Vector2u dimensions(6, 4);
    PacmanTextureSheet.loadFromFile("C:\\Users\\rasyt\\Desktop\\Images\\Pacman16.png");
    Animation pacmananimation(&PacmanTextureSheet, dimensions, 0.5, 10);
    ...
    pacman1.RenderPacman(&pacwindow, &PacmanTextureSheet);
    pacwindow.draw(pacman1.thepacman);
    once = false;
    sf::Time inbetween = sf::seconds(0.4f);
    while (pacwindow.isOpen())
    {
        ...
        while (timeSinceLastUpdate > TimePerFrame)
        {
            ...
            pacwindow.clear();
            DrawMap(&pacwindow, once, pacmanmappointer);
            pacman1.ProcessPacmanMovement(&pacwindow, inbetween, pacmananimation);
            pacwindow.draw(pacman1.thepacman);
            pacwindow.display();
        }
    }
